...
echo "Running Multi BC (early stopping) for seed ${SEED}, on device ${DEVICE}, main task ${MAIN_TASK}, expert dir ${EXPERT_DIR}."
echo "User machine ${USER_MACHINE}, Experiment name ${EXPERIMENT_NAME}."

PYTHON_TO_EXEC=$(cat <<-END
../../rl_sandbox/rl_sandbox/examples/lfgp/run_multitask_bc.py
--seed=${SEED}
