...
EXPERT_DIR=$4
USER_MACHINE=$5
EXPERIMENT_NAME="${EXPERT_DIR}_$6"
...
echo "Running Multi BC for seed ${SEED}, on device ${DEVICE}, main task ${MAIN_TASK}, expert dir ${EXPERT_DIR}."
echo "User machine ${USER_MACHINE}, Experiment name ${EXPERIMENT_NAME}."

PYTHON_TO_EXEC=$(cat <<-END
../../rl_sandbox/rl_sandbox/examples/lfgp/run_multitask_bc_no_overfit.py
--seed=${SEED}
...
# python ../../rl_sandbox/rl_sandbox/examples/lfgp/run_multitask_bc_no_overfit.py \
# --seed="${SEED}" \
# --expert_paths="${EXPERT_PATHS}" \
# --main_task="${MAIN_TASK}_0" \
# --device="${DEVICE}" \
